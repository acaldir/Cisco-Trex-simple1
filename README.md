...
This repository contains scripts and configuration examples for running TRex EMU with ICMP testing between virtual routers (CSR1K). It demonstrates the setup, configuration, and verification steps.
